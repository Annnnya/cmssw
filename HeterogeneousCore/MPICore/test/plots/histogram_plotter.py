...
files = [
    ...
    {"round robin 1+3": "/data/user/apolova/CMSSW_16_0_0_pre3/src/HeterogeneousCore/MPICore/test/test_results/summary_rrb.csv"},
    {"1 event split between 1+3 machines": "/data/user/apolova/CMSSW_16_0_0_pre3/src/HeterogeneousCore/MPICore/test/test_results/summary_1ev_3rm.csv"},
    {"classic 1 local 1 remote": "/data/user/apolova/CMSSW_16_0_0_pre3/src/HeterogeneousCore/MPICore/test/test_results/summary_1-1.csv"},
    {"multiple controllers per local": "/data/user/apolova/CMSSW_16_0_0_pre3/src/HeterogeneousCore/MPICore/test/test_results/summary_mc.csv"},
    {"standalone": "/data/user/apolova/CMSSW_16_0_0_pre3/src/HeterogeneousCore/MPICore/test/test_results/summary_standalone.csv"}


]

output_dir = "./comp_multi"
...
def make_histogram_throughput(df, output_path):
    ...
    colors = ["#336971", "#cb932a", "#a31621", "#758f00", "#000000"]
    ...
    plt.title("Throughput per Thread Count")
