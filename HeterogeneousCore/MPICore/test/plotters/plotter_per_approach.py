...
files = [
    ...
    {"number of products with issend": "/data/user/apolova/dev1/CMSSW_15_0_0/src/HeterogeneousCore/MPICore/test/test_results_thesis/mpich/async_number_of_products_issend/milan-genoa_ucx_t-s-c/local_summary_table.csv"}

]

output_dir = "./milan-genoa-comparative_plots_with_prodnum"
