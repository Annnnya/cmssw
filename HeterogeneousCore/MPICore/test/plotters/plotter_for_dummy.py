...
summary_file = '/data/user/apolova/dev2/CMSSW_15_0_0/src/HeterogeneousCore/MPICore/test/test_results_thesis/dummy/openmpi/simple_async/different_sockets/local_summary_table.csv'
...
plt.savefig("scaling_measurements/dummy_scaling_openmpi_async")